...
<div className="flex justify-center items-center border-t-6 bg-white font-bold text-black h-20 border-white-900 w-full text-center text-5xl shadow-md hover:text-gray-700 transition duration-300 ease-in-out">Looking for a design</div>
      <div
        data-scroll
        data-scroll-speed="-.7"
